...
namespace TheShop.Discount.Services
{
    public class DiscountCodeService : IDiscountCodeService
    {
        ...
        {
            string query = "Select * From DiscountsCodes";
        ...
        {
            string query = "Select * From DiscountsCodes Where DiscountCodeId=@discountCodeId";
            using var connection = _context.CreateConnection();
            var value = await connection.QueryFirstOrDefaultAsync<GetByIdDiscountCodeDto>(query,
                new
                {
                    discountCodeId = id
                });
        ...
        {
            string query = @"Insert Into DiscountsCodes (DiscountCode,Rate,IsActive) Values (@DiscountCode,@Rate,@IsActive)";
            using var connection = _context.CreateConnection();
        ...
        {
            string query = @"Update DiscountsCodes Set DiscountCode=@DiscountCode,Rate=@Rate,IsActive=@IsActive Where DiscountCodeId=@DiscountCodeId";
            using var connection = _context.CreateConnection();
        ...
        {
            string query = "Delete From DiscountsCodes Where DiscountCodeId=@discountCodeId";
            using var connection = _context.CreateConnection();
